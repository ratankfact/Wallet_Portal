      ...
      <div className="flex flex-1 dark:bg-slate-900 dark:text-white z-10">
        ...
        >
          ...
          <nav className="flex-grow mt-0">
            <a href="/admin-order" className="flex items-center space-x-4 py-2 hover:text-gray-200 bg-gray-800 hover:bg-gray-700 rounded-lg px-4 transition duration-200 text-xs">
              <FaShoppingCart className="text-lg" />
              {isSidebarOpen && <span>Order</span>}
            </a>
            <a href="/orders" className="flex items-center space-x-4 py-2 hover:text-gray-200 bg-gray-800 hover:bg-gray-700 rounded-lg px-4 transition duration-200 mt-2 text-xs">
              <FaUndoAlt className="text-lg" />
              {isSidebarOpen && <span>RTO</span>}
            </a>
            <a href="/order-wallet" className="flex items-center space-x-4 py-2 hover:text-gray-200 bg-gray-800 hover:bg-gray-700 rounded-lg px-4 transition duration-200 mt-2 text-xs">
              <FaWallet className="text-lg" />
              {isSidebarOpen && <span>Wallet</span>}
            </a>
            <a href="/your-tiar-status" className="flex items-center space-x-4 py-2 hover:text-gray-200 bg-gray-800 hover:bg-gray-700 rounded-lg px-4 transition duration-200 mt-2 text-xs">
              <FaChartBar className="text-lg" />
              {isSidebarOpen && <span>Tiar</span>}
            </a>
            <a href="/order-bod-fba" className="flex items-center space-x-4 py-2 hover:text-gray-200 bg-gray-800 hover:bg-gray-700 rounded-lg px-4 transition duration-200 mt-2 text-xs">
              <FaLuggageCart className="text-lg" />
              {isSidebarOpen && <span>BOD/FBA</span>}
            </a>
